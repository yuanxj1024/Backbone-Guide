/**
 * Created by AaronYuan on 4/11/16.
 */
...
define(function () {
    ...
    return {
        showError: function (msgHtml) {
            ZENG.msgbox.show(msgHtml, 5, 1500);
        },
        showTip: function (msgHtml) {
            ZENG.msgbox.show(msgHtml, 1, 1500);
        },
        showOK: function (msgHtml) {
            ZENG.msgbox.show(msgHtml, 4, 1500);
        },
        showLoading: function (msgHtml) {
            ZENG.msgbox.show(msgHtml, 6, 1500);
        },
